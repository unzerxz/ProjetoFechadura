...
namespace ProjetoFechadura.Controllers
{
    ...
    public class FuncionarioController : ControllerBase
    {
        ...
        // Método para gerar o token JWT com a claim isAdmin
        private string GenerateJwtToken(int idFuncionario)
        {
            bool isAdmin = _funcionarioDao.IsFuncionarioAdmin(idFuncionario);

            var claims = new List<Claim>
            {
                new Claim("idFuncionario", idFuncionario.ToString()),
                new Claim("isAdmin", isAdmin.ToString().ToLower()) // Adiciona a claim isAdmin
            };
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddHours(24), // Expiração de 24 horas
